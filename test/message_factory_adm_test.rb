...
# 16	ADT_A38		                            MSH;EVN;PID;PD1;PV1;PV2;DB1;OBX;DG1;DRG
  ...
  def _test_all
    ...
    all.each{|e|
      begin
      puts "\n------------------#{e}------------------\n"
      hl7 = MessageFactory.new({std: '2.4', version: ver, event:e, version_store: @@VS, loadfactor: 1}).generate_message()
      # saveMsg(Ez7gen::VERSION+event, hl7, ver)
      puts hl7
      rescue Exception =>z
        errors << e
