...
# @@PERSIST = true
  ...
  def test_all
    ...
    # batch 7
    i_err = ["RSP_K11", "SPQ_Q08"]
    # batch 8
    h_err =  ["RSP_K13", "RTB_K13", "RTB_Q13"] #segment RDF missing second field
    h_err += ["RSP_K25"] #This issue was already reported earlier: ORG.10 and STF.20 need to be populated ONLY
    h_err += ["SQM_S25"]
    #ARQ.13.1 – the value needs to come from table 335
    #APR.5.2 – the value needs to come from table 294

    bl = ["CSU_C9","CSU_C10", "CSU_C11","CSU_C12","MFQ_M01_2","MFQ_M02_2","MFQ_M03_2","MFQ_M04_2", "MFQ_M05_2","MFQ_M06_2","MRG_M01_2", "MFQ_M02_2", "MFQ_M03_3", "MFQ_M04_2", "MFQ_M05_2", "MFQ_M06_2" "NMD","NMQ", "NMR","OMD_O03","PMU_B01", "PMU_B03", "PMU_B04","PMU_B04" ] #black list, Ensemble issues
    bl += ["QBP_Z73", "QBP_Z75", "QBP_Z77", "QBP_Z79", "QBP_Z81","QBP_Z91", "QBP_Z93", "QBP_Z95", "QBP_Z97", "QBP_Z99"] #per Galina
    all = j - er
